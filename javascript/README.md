...
C'est bien simple, je DÉTESTE JavaScript, mais genre vraiment vraiment.

Non parce que des fois, on dit détester un truc mais en fait pas tellement. Là je suis très sérieux : je DÉTESTE
JavaScript.

Mais alors pourquoi faire une section pour ce langage tout pété, si je ne l'aime pas en plus (et même que je le
DETESTE), me demanderez-vous (ou pas).. eh bien, parce qu'étant principalement développeur web, je ne peux pas faire
l'impasse dessus et de ce fait je me le coltine.
